...
#generate a book into web
cargo install mdbook

#games
cargo install battleship-rs
...
#Manage your GnuPG keys with easel
...
#a network diagnostic tool(trip)
